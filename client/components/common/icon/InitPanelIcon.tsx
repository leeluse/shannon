...
export default function InitPanelIcon({ width = 128, height = 128, className = "" }: { width?: number, height?: number, className?: string }) {
    return (
        <svg width={width} height={height} viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <foreignObject x="2" y="2" width="124" height="124"><div xmlns="http://www.w3.org/1999/xhtml" style={{ backdropFilter: 'blur(6px)', clipPath: 'url(#bgblur_0_6_166_clip_path)', height: '100%', width: '100%' }}></div></foreignObject><g filter="url(#filter0_d_6_166)" data-figma-bg-blur-radius="12">
