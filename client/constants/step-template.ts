        ...
        detailTemplates: [
            {
                ...
                fill_text: "프론트엔드 개발자 취업을 위한 포트폴리오 사이트를 만들려고 해. 스타트업 채용담당자가 타깃이고, 프로젝트 3건 이상을 보여줄 거야. 깔끔하고 심플한 스타일로."
            },
            {
                label: "AI 활용 서비스",
    ...
    },
    {
        ...
        detailTemplates: [
            ...
            },
            {
                ...
                fill_text: "팀원 10명이 매일 쓰는 사내 관리자 대시보드를 만들려고 해. 데이터 조회와 간단한 관리 기능이 핵심이고, 빠르고 직관적으로 쓸 수 있어야 해."
            },
            {
                label: "분석 리포트 화면",
